<template>
  <div class="container justify-center py-8">
    <div class="rounded-lg shadow-xl bg-gray-50 lg:w-2/2">
      <div class="m-4 p-4">
        ...
        <div class="flex items-center justify-center w-full">
          ...
          <img v-else class="mt-4 w-96 max-w-96" :src="imgUrl" />
        </div>
      </div>
      <div class="flex m-4 p-4 space-x-4 justify-center">
